...
Techkoningin Base includes support for Infinite Scroll in Jetpack.
...
* techkoningin-base/woocommerce/cart/cart.php version 3.5.0 is out of date. The core version is 3.7.0
...
= 1.2 - Nov 23, 2016 =
* Change the theme name to Techkoningin Base
